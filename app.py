...
.ctor-pos { font-family: 'Rajdhani', sans-serif; font-size: 1.25rem; font-weight: 700; color: #FFFFFF; width: 2.8rem; min-width: 2.8rem; text-align: center; flex-shrink: 0; }
.ctor-pos.top3 { color: #FFD700; /* opcional: destaque dourado para top 3 */}
